 ...
 * combining them with the use of arbitrary {@link TLock} implementations.
 ...
 * To obtain a {@code Condition} instance for a particular {@link TLock}
 * instance use its {@link TLock#newCondition newCondition()} method.
 *
 ...
 * </pre>
 *
 * (The {@link org.teavm.classlib.java.util.concurrent.TArrayBlockingQueue} class provides
 ...
 * {@link TLock} associated with that {@code Condition} or the use of its
