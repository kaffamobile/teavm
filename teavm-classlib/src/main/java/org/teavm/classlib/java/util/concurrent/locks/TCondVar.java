...
class TCondVar implements TCondition, java.io.Serializable {
    ...
    public long awaitNanos(long timeout) throws InterruptedException {
        return Utils.awaitNanos(this, timeout);
    }
    ...
    static interface ExclusiveLock extends TLock {
