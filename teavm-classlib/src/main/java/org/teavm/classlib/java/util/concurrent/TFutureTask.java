 ...
 * implementation of {@link TFuture}, with methods to start and cancel
 ...
 * or cancelled.
 *
 * <p>A <tt>FutureTask</tt> can be used to wrap a {@link TCallable} or
 * {@link java.lang.Runnable} object.  Because <tt>FutureTask</tt>
 * implements <tt>Runnable</tt>, a <tt>FutureTask</tt> can be
 * submitted to an {@link TExecutor} for execution.
 *
 ...
 * @author Doug Lea
 */
public class TFutureTask implements TRunnableFuture {
    ...
    private final TCallable callable;
     ...
     */
    public TFutureTask(TCallable callable) {
        if (callable == null)
     ...
     */
    public TFutureTask(Runnable runnable, Object result) {
        this(TExecutors.callable(runnable, result));
    }
    ...
    /**
     * @throws TCancellationException {@inheritDoc}
     */
     ...
     * @throws TCancellationException {@inheritDoc}
     */
    public synchronized Object get(long timeout, TTimeUnit unit)
     ...
     * PRE: lock owned
     */
    private void waitFor(long nanos) throws InterruptedException, TTimeoutException {
     ...
     * PRE: lock owned
     */
    private Object getResult() throws TExecutionException {
        if (state == CANCELLED) {
