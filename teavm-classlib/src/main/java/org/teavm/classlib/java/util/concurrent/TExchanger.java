...
import org.teavm.classlib.java.util.concurrent.locks.*;
...
public class TExchanger {
     ...
     */
    private Object doExchange(Object x, boolean timed, long nanos) throws InterruptedException, TTimeoutException {
        synchronized (lock) {
            Object other;
            ...
            while (arrivalCount == 2) {
                if (!timed)
                    ...
                    TTimeUnit.NANOSECONDS.timedWait(lock, nanos);
     ...
     * @throws InterruptedException if the current thread was
     *         interrupted while waiting
     * @throws TTimeoutException if the specified waiting time elapses
     *         before another thread enters the exchange
     */
    public Object exchange(Object x, long timeout, TTimeUnit unit)
        throws InterruptedException, TTimeoutException {
