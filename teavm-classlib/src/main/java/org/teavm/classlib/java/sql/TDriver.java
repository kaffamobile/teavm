...
public interface TDriver {
     ...
     */
    public boolean acceptsURL(String url) throws TSQLException;
     ...
     *             if a database error occurs.
     */
    public TConnection connect(String url, Properties info) throws TSQLException;
     ...
     *             if a database error occurs.
     */
    public TDriverPropertyInfo[] getPropertyInfo(String url, Properties info)
            throws TSQLException;
