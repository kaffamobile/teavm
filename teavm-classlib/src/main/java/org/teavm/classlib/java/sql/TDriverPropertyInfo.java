 ...
 * {@link TDriver#getPropertyInfo(String, java.util.Properties)} method and
 * allows for the advanced connection handling.
 */
public class TDriverPropertyInfo {
     ...
     *            The property value.
     */
    public TDriverPropertyInfo(String name, String value) {
        this.name = name;
        this.value = value;
        this.choices = null;
