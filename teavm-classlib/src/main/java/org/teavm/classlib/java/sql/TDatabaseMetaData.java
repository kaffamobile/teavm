 ...
 */
public interface TDatabaseMetaData {
     ...
     */
    public boolean allProceduresAreCallable() throws TSQLException;
     ...
     *             if there is a database error.
     */
    public boolean allTablesAreSelectable() throws TSQLException;
     ...
     *             if there is a database error.
     */
    public boolean dataDefinitionCausesTransactionCommit() throws TSQLException;
     ...
     *             if there is a database error.
     */
    public boolean dataDefinitionIgnoredInTransactions() throws TSQLException;

    /**
     * Returns whether a visible row delete can be detected by calling
     * {@link TResultSet#rowDeleted}.
     * 
     * @param type
     ...
     *             if there is a database error.
     */
    public boolean deletesAreDetected(int type) throws TSQLException;
     ...
     *             if there is a database error.
     */
    public boolean doesMaxRowSizeIncludeBlobs() throws TSQLException;
     ...
     *             if there is a database error.
     */
    public TResultSet getAttributes(String catalog, String schemaPattern,
     ...
     *             if there is a database error.
     */
    public TResultSet getBestRowIdentifier(String catalog, String schema,
            String table, int scope, boolean nullable) throws TSQLException;
     ...
     *             if there is a database error.
     */
    public TResultSet getCatalogs() throws TSQLException;
     ...
     *             if there is a database error.
     */
    public String getCatalogSeparator() throws TSQLException;
     ...
     *             if there is a database error.
     */
    public String getCatalogTerm() throws TSQLException;
     ...
     *             if there is a database error.
     */
    public TResultSet getColumnPrivileges(String catalog, String schema,
            String table, String columnNamePattern) throws TSQLException;
     ...
     *             if there is a database error.
     */
    public TResultSet getColumns(String catalog, String schemaPattern,
     ...
     *             if there is a database error.
     */
    public TResultSet getCrossReference(String primaryCatalog,
            String primarySchema, String primaryTable, String foreignCatalog,
            String foreignSchema, String foreignTable) throws TSQLException;
     ...
     */
    public int getDatabaseMajorVersion() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public int getDatabaseMinorVersion() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public String getDatabaseProductName() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public String getDatabaseProductVersion() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public int getDefaultTransactionIsolation() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public String getDriverName() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public String getDriverVersion() throws TSQLException;
     ...
     *             a database error occurred
     */
    public TResultSet getExportedKeys(String catalog, String schema, String table)
            throws TSQLException;
     ...
     *             a database error occurred.
     */
    public String getExtraNameCharacters() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public String getIdentifierQuoteString() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public TResultSet getImportedKeys(String catalog, String schema, String table)
            throws TSQLException;
     ...
     *             a database error occurred.
     */
    public TResultSet getIndexInfo(String catalog, String schema, String table,
            boolean unique, boolean approximate) throws TSQLException;
     ...
     *             a database error occurred.
     */
    public int getJDBCMajorVersion() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public int getJDBCMinorVersion() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public int getMaxBinaryLiteralLength() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public int getMaxCatalogNameLength() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public int getMaxCharLiteralLength() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public int getMaxColumnNameLength() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public int getMaxColumnsInGroupBy() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public int getMaxColumnsInIndex() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public int getMaxColumnsInOrderBy() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public int getMaxColumnsInSelect() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public int getMaxColumnsInTable() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public int getMaxConnections() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public int getMaxCursorNameLength() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public int getMaxIndexLength() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public int getMaxProcedureNameLength() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public int getMaxRowSize() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public int getMaxSchemaNameLength() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public int getMaxStatementLength() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public int getMaxStatements() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public int getMaxTableNameLength() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public int getMaxTablesInSelect() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public int getMaxUserNameLength() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public String getNumericFunctions() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public TResultSet getPrimaryKeys(String catalog, String schema, String table)
            throws TSQLException;
     ...
     *             a database error occurred.
     */
    public TResultSet getProcedureColumns(String catalog, String schemaPattern,
     ...
     *             a database error occurred.
     */
    public TResultSet getProcedures(String catalog, String schemaPattern,
            String procedureNamePattern) throws TSQLException;
     ...
     *             a database error occurred.
     */
    public String getProcedureTerm() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public int getResultSetHoldability() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public TResultSet getSchemas() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public String getSchemaTerm() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public String getSearchStringEscape() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public String getSQLKeywords() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public int getSQLStateType() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public String getStringFunctions() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public TResultSet getSuperTables(String catalog, String schemaPattern,
            String tableNamePattern) throws TSQLException;
     ...
     *             a database error occurred.
     */
    public TResultSet getSuperTypes(String catalog, String schemaPattern,
            String typeNamePattern) throws TSQLException;
     ...
     *             a database error occurred.
     */
    public String getSystemFunctions() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public TResultSet getTablePrivileges(String catalog, String schemaPattern,
            String tableNamePattern) throws TSQLException;
     ...
     *             a database error occurred.
     */
    public TResultSet getTables(String catalog, String schemaPattern,
            String tableNamePattern, String[] types) throws TSQLException;
     ...
     *             a database error occurred.
     */
    public TResultSet getTableTypes() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public String getTimeDateFunctions() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public TResultSet getTypeInfo() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public TResultSet getUDTs(String catalog, String schemaPattern,
            String typeNamePattern, int[] types) throws TSQLException;
     ...
     *             a database error occurred.
     */
    public String getUserName() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public TResultSet getVersionColumns(String catalog, String schema,
            String table) throws TSQLException;
     ...
     * @throws TSQLException
     *             a database error occurred.
     * @see TResultSet#rowInserted()
     */
    public boolean insertsAreDetected(int type) throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean isCatalogAtStart() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean isReadOnly() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean locatorsUpdateCopy() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean nullPlusNonNullIsNull() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean nullsAreSortedAtEnd() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean nullsAreSortedAtStart() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean nullsAreSortedHigh() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean nullsAreSortedLow() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean othersDeletesAreVisible(int type) throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean othersInsertsAreVisible(int type) throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean othersUpdatesAreVisible(int type) throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean ownDeletesAreVisible(int type) throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean ownInsertsAreVisible(int type) throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean ownUpdatesAreVisible(int type) throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean storesLowerCaseIdentifiers() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean storesLowerCaseQuotedIdentifiers() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean storesMixedCaseIdentifiers() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean storesMixedCaseQuotedIdentifiers() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean storesUpperCaseIdentifiers() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean storesUpperCaseQuotedIdentifiers() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean supportsAlterTableWithAddColumn() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean supportsAlterTableWithDropColumn() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean supportsANSI92EntryLevelSQL() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean supportsANSI92FullSQL() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean supportsANSI92IntermediateSQL() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean supportsBatchUpdates() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean supportsCatalogsInDataManipulation() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean supportsCatalogsInIndexDefinitions() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean supportsCatalogsInPrivilegeDefinitions() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean supportsCatalogsInProcedureCalls() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean supportsCatalogsInTableDefinitions() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean supportsColumnAliasing() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean supportsConvert() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean supportsCoreSQLGrammar() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean supportsCorrelatedSubqueries() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean supportsDifferentTableCorrelationNames() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean supportsExpressionsInOrderBy() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean supportsExtendedSQLGrammar() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean supportsFullOuterJoins() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean supportsGetGeneratedKeys() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean supportsGroupBy() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean supportsGroupByBeyondSelect() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean supportsGroupByUnrelated() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean supportsIntegrityEnhancementFacility() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean supportsLikeEscapeClause() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean supportsLimitedOuterJoins() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean supportsMinimumSQLGrammar() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean supportsMixedCaseIdentifiers() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean supportsMixedCaseQuotedIdentifiers() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean supportsMultipleOpenResults() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean supportsMultipleResultSets() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean supportsMultipleTransactions() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean supportsNamedParameters() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean supportsNonNullableColumns() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean supportsOpenCursorsAcrossCommit() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean supportsOpenCursorsAcrossRollback() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean supportsOpenStatementsAcrossCommit() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean supportsOpenStatementsAcrossRollback() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean supportsOrderByUnrelated() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean supportsOuterJoins() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean supportsPositionedDelete() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean supportsPositionedUpdate() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean supportsResultSetType(int type) throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean supportsSavepoints() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean supportsSchemasInDataManipulation() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean supportsSchemasInIndexDefinitions() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean supportsSchemasInPrivilegeDefinitions() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean supportsSchemasInProcedureCalls() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean supportsSchemasInTableDefinitions() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean supportsSelectForUpdate() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean supportsStatementPooling() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean supportsStoredProcedures() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean supportsSubqueriesInComparisons() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean supportsSubqueriesInExists() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean supportsSubqueriesInIns() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean supportsSubqueriesInQuantifieds() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean supportsTableCorrelationNames() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean supportsTransactions() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean supportsUnion() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean supportsUnionAll() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean updatesAreDetected(int type) throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean usesLocalFilePerTable() throws TSQLException;
     ...
     *             a database error occurred.
     */
    public boolean usesLocalFiles() throws TSQLException;
}
