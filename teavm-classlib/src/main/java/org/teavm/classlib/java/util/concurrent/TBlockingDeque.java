 ...
 *    <td>{@link #offerFirst(Object, long, TTimeUnit) offerFirst(e, time, unit)}</td>
 *  </tr>
 *  <tr>
 *    <td><b>Remove</b></td>
 ...
 *    <td>{@link #pollFirst(long, TTimeUnit) pollFirst(time, unit)}</td>
 *  </tr>
 *  <tr>
 *    <td><b>Examine</b></td>
 ...
 *    <td>{@link #offerLast(Object, long, TTimeUnit) offerLast(e, time, unit)}</td>
 *  </tr>
 *  <tr>
 *    <td><b>Remove</b></td>
 ...
 *    <td>{@link #pollLast(long, TTimeUnit) pollLast(time, unit)}</td>
 *  </tr>
 *  <tr>
 *    <td><b>Examine</b></td>
 ...
 * </table>
 *
 * <p>Like any {@link TBlockingQueue}, a <tt>BlockingDeque</tt> is thread safe,
 ...
 *  </tr>
 *  <tr>
 *    <td>{@link #offer(Object, long, TTimeUnit) offer(e, time, unit)}</td>
 *    <td>{@link #offerLast(Object, long, TTimeUnit) offerLast(e, time, unit)}</td>
 *  </tr>
 *  <tr>
 ...
 *  </tr>
 *  <tr>
 *    <td>{@link #poll(long, TTimeUnit) poll(time, unit)}</td>
 *    <td>{@link #pollFirst(long, TTimeUnit) pollFirst(time, unit)}</td>
 *  </tr>
 *  <tr>
 ...
 * @author Doug Lea
 */
public interface TBlockingDeque<E> extends TBlockingQueue<E>, Deque<E> {
    /*
     ...
     *         element prevents it from being added to this deque
     */
    boolean offerFirst(Object e, long timeout, TTimeUnit unit)
     ...
     *         element prevents it from being added to this deque
     */
    boolean offerLast(Object e, long timeout, TTimeUnit unit)
        throws InterruptedException;
     ...
     * @throws InterruptedException if interrupted while waiting
     */
    Object pollFirst(long timeout, TTimeUnit unit)
        throws InterruptedException;
     ...
     * @throws InterruptedException if interrupted while waiting
     */
    Object pollLast(long timeout, TTimeUnit unit)
        throws InterruptedException;
     ...
     * {@link #offerLast(Object,long,TTimeUnit) offerLast}.
     *
     * @param e the element to add
     ...
     *         element prevents it from being added to this deque
     */
    boolean offer(Object e, long timeout, TTimeUnit unit)
        throws InterruptedException;
     ...
     *
     * <p>This method is equivalent to
     * {@link #pollFirst(long,TTimeUnit) pollFirst}.
     *
     * @return the head of this deque, or <tt>null</tt> if the
     *         specified waiting time elapses before an element is available
     * @throws InterruptedException if interrupted while waiting
     */
    E poll(long timeout, TTimeUnit unit)
        throws InterruptedException;
