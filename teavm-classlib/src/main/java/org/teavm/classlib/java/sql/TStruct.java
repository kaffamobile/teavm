...
public interface TStruct {
     ...
     */
    public String getSQLTypeName() throws TSQLException;

    /**
     * Gets the values of the attributes of this SQL structured type. This
     * method uses the type map associated with the {@link TConnection} for
     ...
     *             if a database error occurs.
     */
    public Object[] getAttributes() throws TSQLException;
