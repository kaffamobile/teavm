...
public interface TResultSet {
     ...
     * from one of the {@link TDatabaseMetaData} methods), {@code null} is
     * returned.
     * 
     ...
     *             if a database error happens.
     */
    public TURL getURL(int columnIndex) throws TSQLException;
     ...
     *             if a database error happens.
     */
    public TURL getURL(String columnName) throws TSQLException;
