 ...
 * @author Doug Lea
 */
public class TAtomicMarkableReference  {
    ...
    private final TAtomicReference atomicRef;
     ...
     */
    public TAtomicMarkableReference(Object initialRef, boolean initialMark) {
        atomicRef = new TAtomicReference(new ReferenceBooleanPair(initialRef, initialMark));
    }
