...
public interface TClob {
     ...
     */
    public InputStream getAsciiStream() throws TSQLException;
     ...
     *             if an error occurs accessing the {@code Clob}.
     */
    public Reader getCharacterStream() throws TSQLException;
     ...
     *             if an error occurs accessing the {@code Clob}.
     */
    public String getSubString(long pos, int length) throws TSQLException;
     ...
     *             if an error occurs accessing the {@code Clob}.
     */
    public long length() throws TSQLException;
     ...
     *             if an error occurs accessing the {@code Clob}.
     */
    public long position(TClob searchstr, long start) throws TSQLException;
     ...
     *             if an error occurs accessing the {@code Clob}.
     */
    public long position(String searchstr, long start) throws TSQLException;
     ...
     *             if an error occurs accessing the {@code Clob}.
     */
    public OutputStream setAsciiStream(long pos) throws TSQLException;
     ...
     *             if an error occurs accessing the {@code Clob}.
     */
    public Writer setCharacterStream(long pos) throws TSQLException;
     ...
     *             if an error occurs accessing the {@code Clob}.
     */
    public int setString(long pos, String str) throws TSQLException;
     ...
     *             if an error occurs accessing the {@code Clob}.
     */
    public void truncate(long len) throws TSQLException;
}
