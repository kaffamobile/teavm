...
/**
 * A type of {@link TPropertyChangeEvent} that indicates that an indexed property
 * has changed.
 * 
 * @since 1.5
 */
public class TIndexedPropertyChangeEvent extends TPropertyChangeEvent {
     ...
     */
    public TIndexedPropertyChangeEvent(Object source, String propertyName,
