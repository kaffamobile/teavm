 ...
 * {@link TPreparedStatement#setRef(int, Ref)} method.
 */
public interface TRef {
     ...
     *             if there is a database error.
     */
    public Object getObject() throws TSQLException;
     ...
     *             if there is a database error.
     */
    public Object getObject(Map<String, Class<?>> map) throws TSQLException;
     ...
     *             if there is a database error.
     */
    public void setObject(Object value) throws TSQLException;
}
