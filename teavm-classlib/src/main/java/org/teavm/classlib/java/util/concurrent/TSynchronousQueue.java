...
/**
 * A {@linkplain TBlockingQueue blocking queue} in which each insert
 ...
 * @author Doug Lea
 */
public class TSynchronousQueue extends AbstractQueue
    ...
    */
    ...
    private final TReentrantLock qlock;
    ...
    public TSynchronousQueue(boolean fair) {
        if (fair) {
            qlock = new TReentrantLock(true);
            waitingProducers = new FifoWaitQueue();
            waitingConsumers = new FifoWaitQueue();
        }
        else {
            qlock = new TReentrantLock();
    ...
    public void put(Object e) throws InterruptedException {
        ...
        final TReentrantLock qlock = this.qlock;
     ...
     * @throws NullPointerException {@inheritDoc}
     */
    public boolean offer(Object e, long timeout, TTimeUnit unit) throws InterruptedException {
        if (e == null) throw new NullPointerException();
