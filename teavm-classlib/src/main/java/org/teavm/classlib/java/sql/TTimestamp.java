 ...
 * @see java.util.Date
 */
public class TTimestamp extends Date {
     ...
     */
    @Deprecated
    public TTimestamp(int theYear, int theMonth, int theDate, int theHour,
     ...
     */
    public TTimestamp(long theTime) {
        super(theTime);
        /*
     ...
     */
    public boolean after(TTimestamp theTimestamp) {
     ...
     *         supplied timestamp, {@code false} otherwise.
     */
    public boolean before(TTimestamp theTimestamp) {
        long thisTime = this.getTime();
        long compareTime = theTimestamp.getTime();
    ...
    public int compareTo(Date theObject) {
        if(theObject instanceof TTimestamp){
            return this.compareTo((TTimestamp)theObject);
        }
     ...
     *         </ul>
     */
    public int compareTo(TTimestamp theTimestamp) {
    ...
    public boolean equals(Object theObject) {
        if (theObject instanceof TTimestamp) {
            return equals((TTimestamp) theObject);
        }
        return false;
    }
     ...
     */
    public boolean equals(TTimestamp theTimestamp) {
    ...
    */ 
     ...
     */
    public static TTimestamp valueOf(String s) throws IllegalArgumentException {
        if (s == null) {
        ...
        TTimestamp theTimestamp = new TTimestamp(theDate.getTime());
