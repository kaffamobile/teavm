 ...
 */
public interface TParameterMetaData {
     ...
     */
    public String getParameterClassName(int paramIndex) throws TSQLException;
     ...
     *             if a database error happens.
     */
    public int getParameterCount() throws TSQLException;
     ...
     *             if a database error happens.
     */
    public int getParameterMode(int paramIndex) throws TSQLException;
     ...
     *             if a database error happens.
     */
    public int getParameterType(int paramIndex) throws TSQLException;
     ...
     *             if a database error happens.
     */
    public String getParameterTypeName(int paramIndex) throws TSQLException;
     ...
     *             if a database error happens.
     */
    public int getPrecision(int paramIndex) throws TSQLException;
     ...
     *             if a database error happens.
     */
    public int getScale(int paramIndex) throws TSQLException;
     ...
     */
    public int isNullable(int paramIndex) throws TSQLException;
     ...
     *             if a database error happens.
     */
    public boolean isSigned(int paramIndex) throws TSQLException;
}
