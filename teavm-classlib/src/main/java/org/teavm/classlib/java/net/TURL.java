 ...
 */
public final class TURL implements java.io.Serializable {
     ...
     */
    private static Hashtable<String, TURLStreamHandler> streamHandlers = new Hashtable<String, TURLStreamHandler>();
    ...
    public static synchronized void setURLStreamHandlerFactory(
            TURLStreamHandlerFactory streamFactory) {
     ...
     *             URL.
     */
    public TURL(String spec) throws MalformedURLException {
        this((TURL) null, spec, (TURLStreamHandler) null);
    }
     ...
     */
    public TURL(TURL context, String spec) throws MalformedURLException {
        this(context, spec, (TURLStreamHandler) null);
    }
     ...
     *             or an invalid protocol has been found.
     */
    public TURL(TURL context, String spec, TURLStreamHandler handler)
            throws MalformedURLException {
        if (handler != null) {
            SecurityManager sm = System.getSecurityManager();
            if (sm != null) {
     ...
     */
    public TURL(String protocol, String host, String file)
            throws MalformedURLException {
        this(protocol, host, -1, file, (TURLStreamHandler) null);
    }
     ...
     *             URL or the protocol is invalid.
     */
    public TURL(String protocol, String host, int port, String file)
            throws MalformedURLException {
        this(protocol, host, port, file, (TURLStreamHandler) null);
    }
     ...
     */
    public TURL(String protocol, String host, int port, String file,
            TURLStreamHandler handler) throws MalformedURLException {
        if (port < -1) {
    ...
    void setupStreamHandler() {
        ...
        String className = "org.apache.harmony.luni.internal.net.www.protocol." + protocol //$NON-NLS-1$
                + ".Handler"; //$NON-NLS-1$
        try {
            strmHandler = (TURLStreamHandler) Class.forName(className)
                    .newInstance();
     ...
     * @see TURLStreamHandler#getDefaultPort
     */
