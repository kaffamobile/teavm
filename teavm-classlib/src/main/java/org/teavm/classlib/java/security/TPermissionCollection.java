 ...
 * {@link TPermission#newPermissionCollection()} factory method. If the mentioned
 ...
 */
public abstract class TPermissionCollection implements Serializable {
    ...
    /**
     * Returns an enumeration over all {@link TPermission}s encapsulated by this
     * {@code PermissionCollection}.
     * 
     * @return an enumeration over all {@link TPermission}s.
     */
    ...
    public String toString() {
        ...
        Enumeration<TPermission> elenum = elements();
