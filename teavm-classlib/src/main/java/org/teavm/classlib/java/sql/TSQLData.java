 ...
 * is accessed with the {@link TResultSet#getObject} method and is returned as an
 ...
 * {@link TPreparedStatement#setObject} method which performs the reverse mapping
...
public interface TSQLData {
     ...
     * @see TSQLInput
     */
    public void readSQL(TSQLInput stream, String typeName) throws TSQLException;
     ...
     * @see TSQLOutput
     */
    public void writeSQL(TSQLOutput stream) throws TSQLException;
}
