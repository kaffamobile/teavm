 ...
 * a {@link TConcurrentSkipListMap}.  The elements of the set are kept
 ...
 * @since 1.6
 */
public class TConcurrentSkipListSet<E>
     ...
     */
    public TConcurrentSkipListSet(Comparator comparator) {
        m = new TConcurrentSkipListMap(comparator);
    }
     ...
     */
    public TConcurrentSkipListSet(Collection c) {
        m = new TConcurrentSkipListMap();
        addAll(c);
    }
     ...
     *         of its elements are null
     */
    public TConcurrentSkipListSet(SortedSet s) {
        m = new TConcurrentSkipListMap(s.comparator());
        addAll(s);
    }
     ...
     * For use by submaps
     */
    TConcurrentSkipListSet(TConcurrentNavigableMap m) {
        this.m = m;
    }
     ...
     */
    public Object clone() {
        if (this.getClass() != TConcurrentSkipListSet.class) {
            // can't change m, since it is final
            throw new UnsupportedOperationException("Can't clone subclasses");
        }
        return new TConcurrentSkipListSet(new TConcurrentSkipListMap(this.m));
    }
