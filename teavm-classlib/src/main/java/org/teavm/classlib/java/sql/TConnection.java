...
public interface TConnection {
     ...
     * @see TResultSet
     */
    public TStatement createStatement() throws TSQLException;
     ...
     *            <ul>
     *            <li>{@link TResultSet#TYPE_SCROLL_SENSITIVE} </li> <li>
     *            {@link TResultSet#TYPE_SCROLL_INSENSITIVE} </li> <li>
     *            {@link TResultSet#TYPE_FORWARD_ONLY}</li>
     *            </ul>
     * @param resultSetConcurrency
     *            one of the following concurrency mode specifiers:
     *            <ul>
     *            <li>{@link TResultSet#CONCUR_UPDATABLE}</li> <li>
     *            {@link TResultSet#CONCUR_READ_ONLY}</li>
     *            </ul>
     ...
     *            one of the following type specifiers:
     *            <ul>
     *            <li>{@link TResultSet#TYPE_SCROLL_SENSITIVE}</li>
     *            <li>{@link TResultSet#TYPE_SCROLL_INSENSITIVE}</li>
     *            <li>{@link TResultSet#TYPE_FORWARD_ONLY}</li>
     *            </ul>
     * @param resultSetConcurrency
     *            one of the following concurrency mode specifiers:
     *            <ul>
     *            <li>{@link TResultSet#CONCUR_UPDATABLE}</li>
     *            <li>{@link TResultSet#CONCUR_READ_ONLY}</li>
     *            </ul>
     * @param resultSetHoldability
     *            one of the following holdability mode specifiers:
     *            <ul>
     *            <li>{@link TResultSet#HOLD_CURSORS_OVER_COMMIT}</li>
     *            <li>{@link TResultSet#CLOSE_CURSORS_AT_COMMIT}</li>
     *            </ul>
     ...
     *             if there is a problem accessing the database.
     */
    public boolean getAutoCommit() throws TSQLException;
     ...
     *             if there is a problem accessing the database.
     */
    public String getCatalog() throws TSQLException;
     ...
     *         <ul>
     *         <li>{@link TResultSet#HOLD_CURSORS_OVER_COMMIT}</li> <li>
     *         {@link TResultSet#CLOSE_CURSORS_AT_COMMIT}</li>
     *         </ul>
     * @throws TSQLException
     *             if there is a problem accessing the a database.
     */
    public int getHoldability() throws TSQLException;
     ...
     *             if there is a problem accessing the a database.
     */
    public TDatabaseMetaData getMetaData() throws TSQLException;
     ...
     */
    public int getTransactionIsolation() throws TSQLException;
     ...
     *             if there is a problem accessing the database.
     */
    public Map<String, Class<?>> getTypeMap() throws TSQLException;
     ...
     * <p>
     * By invoking the {@link TSQLWarning#getNextWarning()} method of the
     ...
     *             if there is a problem accessing the database.
     */
    public boolean isClosed() throws TSQLException;
     ...
     *             if there is a problem accessing the database
     */
    public String nativeSQL(String sql) throws TSQLException;
     ...
     *         {@link TResultSet#TYPE_FORWARD_ONLY} and concurrency
     *         {@link TResultSet#CONCUR_READ_ONLY}.
     * @throws TSQLException
     *             if a problem occurs accessing the database.
     */
    public TCallableStatement prepareCall(String sql) throws TSQLException;
     ...
     *             if a problem occurs accessing the database
     */
    public TCallableStatement prepareCall(String sql, int resultSetType,
            int resultSetConcurrency) throws TSQLException;
     ...
     * {@link TResultSet#TYPE_FORWARD_ONLY} type with a
     * {@link TResultSet#CONCUR_READ_ONLY} mode of concurrency.
     * 
     * @param sql
     *            the SQL statement.
     ...
     *             if there is a problem accessing the database.
     */
    public TPreparedStatement prepareStatement(String sql) throws TSQLException;
     ...
     *            <ul>
     *            <li>{@link TStatement#RETURN_GENERATED_KEYS}</li>
     *            <li>{@link TStatement#NO_GENERATED_KEYS}</li>
     *            </ul>
     ...
     * By default, {@code ResultSet}s from the returned object will be
     * {@link TResultSet#TYPE_FORWARD_ONLY} type with a
     * {@link TResultSet#CONCUR_READ_ONLY} concurrency mode.
     *
     * @param sql
     *            the SQL statement.
     * @param columnIndexes
     ...
     *             transaction.
     */
    public void releaseSavepoint(TSavepoint savepoint) throws TSQLException;
     ...
     *             if there is a problem accessing the database.
     */
    public void rollback(TSavepoint savepoint) throws TSQLException;
     ...
     *             if there is a problem accessing the database.
     */
    public void setAutoCommit(boolean autoCommit) throws TSQLException;
     ...
     *             if there is a problem accessing the database.
     */
    public void setCatalog(String catalog) throws TSQLException;
     ...
     *             if there is a problem accessing the database
     */
    public void setHoldability(int holdability) throws TSQLException;
     ...
     *             if there is a problem accessing the database.
     */
    public void setReadOnly(boolean readOnly) throws TSQLException;
     ...
     *             if there is a problem accessing the database.
     */
    public TSavepoint setSavepoint() throws TSQLException;
     ...
     *             if there is a problem accessing the database.
     */
    public TSavepoint setSavepoint(String name) throws TSQLException;
     ...
     */
    public void setTypeMap(Map<String, Class<?>> map) throws TSQLException;
}
