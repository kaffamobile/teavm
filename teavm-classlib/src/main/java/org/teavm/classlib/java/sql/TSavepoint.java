 ...
 * by a rollback via the {@link TConnection#rollback} command. Rolling back to a
 * particular savepoint means that all changes that occurred after that
 * savepoint are undone.
 */
public interface TSavepoint {
     ...
     */
    public int getSavepointId() throws TSQLException;
     ...
     *             if an error occurrs accessing the database.
     */
    public String getSavepointName() throws TSQLException;
}
