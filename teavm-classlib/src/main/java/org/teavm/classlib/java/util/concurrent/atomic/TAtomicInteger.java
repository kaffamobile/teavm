 ...
 * {@link org.teavm.classlib.java.util.concurrent.atomic} package specification for
 ...
 * @author Doug Lea
*/
public class TAtomicInteger extends Number implements java.io.Serializable {
     ...
     */
    public TAtomicInteger(int initialValue) {
        value = initialValue;
    }
