 ...
 */
public class TSQLWarning extends TSQLException implements Serializable {
     ...
     */
    public TSQLWarning(String theReason) {
        super(theReason);
    }
     ...
     */
    public TSQLWarning(String theReason, String theSQLState) {
     ...
     */
    public TSQLWarning(String theReason, String theSQLState, int theErrorCode) {
     ...
     *         SQLWarning}.
     */
    public TSQLWarning getNextWarning() {
        TSQLException next = super.getNextException();
        if (next == null) {
            return null;
        }
        if (next instanceof TSQLWarning) {
            return (TSQLWarning) next;
        }
     ...
     */
    public void setNextWarning(TSQLWarning w) {
