...
/**
 * An optionally-bounded {@linkplain TBlockingDeque blocking deque} based on
 * linked nodes.
 *
...
public class TLinkedBlockingDeque
    ...
    implements TBlockingDeque,  java.io.Serializable {
     ...
     */
    public TLinkedBlockingDeque(Collection c) {
        this(Integer.MAX_VALUE);
     ...
     * @throws InterruptedException {@inheritDoc}
     */
    public boolean offerFirst(Object e, long timeout, TTimeUnit unit)
     ...
     * @throws InterruptedException {@inheritDoc}
     */
    public boolean offerLast(Object e, long timeout, TTimeUnit unit)
        throws InterruptedException {
        if (e == null) throw new NullPointerException();
        long nanos = unit.toNanos(timeout);
        lock.lockInterruptibly();
    ...
    public Object pollFirst(long timeout, TTimeUnit unit)
        throws InterruptedException {
        long nanos = unit.toNanos(timeout);
        lock.lockInterruptibly();
        try {
    ...
    public Object pollLast(long timeout, TTimeUnit unit)
        throws InterruptedException {
        long nanos = unit.toNanos(timeout);
        lock.lockInterruptibly();
        try {
    ...
    private class Itr extends AbstractItr {
        void advance() {
            final TReentrantLock lock = TLinkedBlockingDeque.this.lock;
            lock.lock();
            try {
