 ...
 * @author Doug Lea
 */
public class TConcurrentHashMap<K, V> extends AbstractMap<K, V>
     ...
     */
    static final class Segment extends TReentrantLock implements Serializable {
        /*
     ...
     * @param m the map
     */
    public TConcurrentHashMap(Map m) {
    ...
    public V remove(Object key) {
        int hash = hash(key.hashCode()); // throws NullPointerException if key null
        return (V) segmentFor(hash).remove(key, hash, null);
    }
    ...
    abstract class HashIterator {
        ...
        public void remove() {
            ...
            TConcurrentHashMap.this.remove(lastReturned.key);
            lastReturned = null;
        }
    }
        ...
        extends AbstractMap.SimpleEntry
    {
        ...
        public V setValue(Object value) {
            ...
            TConcurrentHashMap.this.put((K) getKey(), (V) value);
            return v;
        }
    }
    ...
    final class KeySet extends AbstractSet {
        ...
        public boolean contains(Object o) {
            return TConcurrentHashMap.this.containsKey(o);
        }
        public boolean remove(Object o) {
            return TConcurrentHashMap.this.remove(o) != null;
        }
        public void clear() {
    ...
    final class Values extends AbstractCollection {
        ...
        public boolean contains(Object o) {
            return TConcurrentHashMap.this.containsValue(o);
        }
        public void clear() {
            TConcurrentHashMap.this.clear();
        }
    ...
    final class EntrySet extends AbstractSet {
        ...
        public boolean contains(Object o) {
            ...
            Object v = TConcurrentHashMap.this.get(e.getKey());
        ...
        public boolean remove(Object o) {
            if (!(o instanceof Map.Entry))
                return false;
            Map.Entry e = (Map.Entry)o;
            return TConcurrentHashMap.this.remove(e.getKey(), e.getValue());
        }
        public int size() {
            return TConcurrentHashMap.this.size();
        }
