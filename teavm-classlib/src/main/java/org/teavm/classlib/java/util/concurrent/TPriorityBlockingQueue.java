...
/**
 * An unbounded {@linkplain TBlockingQueue blocking queue} that uses
 ...
 * @author Doug Lea
 */
public class TPriorityBlockingQueue extends AbstractQueue
    implements TBlockingQueue, java.io.Serializable {
    private static final long serialVersionUID = 5595510919245408276L;

    private final PriorityQueue q;
    private final TReentrantLock lock = new TReentrantLock(true);
     ...
     */
    public TPriorityBlockingQueue(Collection c) {
