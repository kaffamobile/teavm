 ...
 *
 * @see TResultSet
 * @see TConnection#createStatement
 */
public interface TStatement {
     ...
     */
    public void addBatch(String sql) throws TSQLException;
     ...
     */
    public void cancel() throws TSQLException;
     ...
     *             does not support batch updates.
     */
    public void clearBatch() throws TSQLException;
     ...
     *             if an error occurs accessing the database.
     */
    public boolean execute(String sql) throws TSQLException;
     ...
     *             if an error occurs accessing the database.
     */
    public boolean execute(String sql, int[] columnIndexes) throws TSQLException;
     ...
     * {@link TBatchUpdateException} and the JDBC driver may or may not process
     ...
     *             if an error occurs accessing the database.
     */
    public int[] executeBatch() throws TSQLException;
     ...
     */
    public TResultSet executeQuery(String sql) throws TSQLException;
     ...
     */
    public int executeUpdate(String sql) throws TSQLException;
     ...
     *             if an error occurs accessing the database.
     */
    public TResultSet getGeneratedKeys() throws TSQLException;
     ...
     *             if an error occurs accessing the database.
     */
    public boolean getMoreResults() throws TSQLException;
     ...
     *             if an error occurs accessing the database.
     */
    public boolean getMoreResults(int current) throws TSQLException;
     ...
     *             if an error occurs accessing the database.
     */
    public int getResultSetConcurrency() throws TSQLException;
     ...
     */
    public int getResultSetType() throws TSQLException;
     ...
     *             if an error occurs accessing the database.
     */
    public int getUpdateCount() throws TSQLException;
     ...
     *             if an error occurs accessing the database.
     */
    public void setCursorName(String name) throws TSQLException;
     ...
     * to {@link TPreparedStatement}s since they are processed when created,
