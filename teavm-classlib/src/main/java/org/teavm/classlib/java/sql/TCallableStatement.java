 ...
 */
public interface TCallableStatement extends TPreparedStatement {
     ...
     */
    public TArray getArray(int parameterIndex) throws TSQLException;
     ...
     */
    public TArray getArray(String parameterName) throws TSQLException;
     ...
     *             if a database error occurs.
     */
    public BigDecimal getBigDecimal(int parameterIndex) throws TSQLException;
     ...
     *             if a database error occurs.
     */
    public BigDecimal getBigDecimal(String parameterName) throws TSQLException;
     ...
     *             if a database error occurs.
     */
    public TBlob getBlob(int parameterIndex) throws TSQLException;
     ...
     *             if a database error occurs.
     */
    public TBlob getBlob(String parameterName) throws TSQLException;
     ...
     *             if a database error occurs.
     */
    public boolean getBoolean(int parameterIndex) throws TSQLException;
     ...
     *             if a database error occurs.
     */
    public boolean getBoolean(String parameterName) throws TSQLException;
     ...
     *             if a database error occurs.
     */
    public byte getByte(int parameterIndex) throws TSQLException;
     ...
     *             if a database error occurs.
     */
    public byte getByte(String parameterName) throws TSQLException;
     ...
     *             if a database error occurs.
     */
    public byte[] getBytes(int parameterIndex) throws TSQLException;
     ...
     *             if a database error occurs.
     */
    public byte[] getBytes(String parameterName) throws TSQLException;
     ...
     * @see TClob
     */
    public TClob getClob(int parameterIndex) throws TSQLException;
     ...
     * @see TClob
     */
    public TClob getClob(String parameterName) throws TSQLException;
     ...
     * @see TDate
     */
    public TDate getDate(int parameterIndex) throws TSQLException;
     ...
     * @see TDate
     */
    public TDate getDate(int parameterIndex, Calendar cal) throws TSQLException;
     ...
     * @see TDate
     */
    public TDate getDate(String parameterName) throws TSQLException;
     ...
     * @see TDate
     */
    public TDate getDate(String parameterName, Calendar cal) throws TSQLException;
     ...
     *             if a database error occurs.
     */
    public double getDouble(int parameterIndex) throws TSQLException;
     ...
     *             if there is a problem accessing the database.
     */
    public double getDouble(String parameterName) throws TSQLException;
     ...
     *             if a database error occurs.
     */
    public float getFloat(int parameterIndex) throws TSQLException;
     ...
     *             if there is a problem accessing the database.
     */
    public float getFloat(String parameterName) throws TSQLException;
     ...
     *             if a database error occurs.
     */
    public int getInt(int parameterIndex) throws TSQLException;
     ...
     *             if a database error occurs.
     */
    public int getInt(String parameterName) throws TSQLException;
     ...
     *             if a database error occurs.
     */
    public long getLong(int parameterIndex) throws TSQLException;
     ...
     *             if a database error occurs.
     */
    public long getLong(String parameterName) throws TSQLException;
     ...
     *             if a database error occurs.
     */
    public Object getObject(int parameterIndex) throws TSQLException;
     ...
     *             if there is a problem accessing the database.
     */
    public Object getObject(String parameterName) throws TSQLException;
     ...
     *             if a database error occurs.
     */
    public TRef getRef(int parameterIndex) throws TSQLException;
     ...
     * @see TRef
     */
    public TRef getRef(String parameterName) throws TSQLException;
     ...
     *             if a database error occurs.
     */
    public short getShort(int parameterIndex) throws TSQLException;
     ...
     *             if there is a problem accessing the database.
     */
    public short getShort(String parameterName) throws TSQLException;
     ...
     *             if there is a problem accessing the database.
     */
    public String getString(int parameterIndex) throws TSQLException;
     ...
     *             if there is a problem accessing the database.
     */
    public String getString(String parameterName) throws TSQLException;
     ...
     * @see TTime
     */
    public TTime getTime(int parameterIndex) throws TSQLException;
     ...
     */
    public TTime getTime(int parameterIndex, Calendar cal) throws TSQLException;
     ...
     * @see TTime
     */
    public TTime getTime(String parameterName) throws TSQLException;
     ...
     * @see java.util.Calendar
     */
    public TTime getTime(String parameterName, Calendar cal) throws TSQLException;
     ...
     * @see TTimestamp
     */
    public TTimestamp getTimestamp(int parameterIndex) throws TSQLException;
     ...
     * @see TTimestamp
     */
    public TTimestamp getTimestamp(int parameterIndex, Calendar cal)
            throws TSQLException;
     ...
     * @see TTimestamp
     */
    public TTimestamp getTimestamp(String parameterName) throws TSQLException;
     ...
     * @see TTimestamp
     */
    public TTimestamp getTimestamp(String parameterName, Calendar cal)
            throws TSQLException;
     ...
     * @throws TSQLException
     *             if a database error occurs.
     * @see org.teavm.classlib.java.net.TURL
     */
    public TURL getURL(int parameterIndex) throws TSQLException;
     ...
     * @see org.teavm.classlib.java.net.TURL
     */
    public TURL getURL(String parameterName) throws TSQLException;
     ...
     *            index 1.
     * @param sqlType
     *            a JDBC type expressed as a constant from {@link TTypes}.
     * @param typeName
    ...
    public void registerOutParameter(int paramIndex, int sqlType,
            String typeName) throws TSQLException;
     ...
     *            the parameter name.
     * @param sqlType
     *            a JDBC type expressed as a constant from {@link TTypes}. Types
     ...
     *             if a database error occurs.
     */
    public void setByte(String parameterName, byte theByte) throws TSQLException;
     ...
     *             if a database error occurs.
     */
    public void setDate(String parameterName, TDate theDate) throws TSQLException;
     ...
     * @see TDate
     */
    public void setDate(String parameterName, TDate theDate, Calendar cal)
            throws TSQLException;
     ...
     *             if a database error occurs.
     */
    public void setInt(String parameterName, int theInt) throws TSQLException;
     ...
     *             if a database error occurs.
     */
    public void setLong(String parameterName, long theLong) throws TSQLException;
     ...
     *             if a database error occurs.
     */
    public void setNull(String parameterName, int sqlType) throws TSQLException;
     ...
     * @see TTime
     */
    public void setTime(String parameterName, TTime theTime) throws TSQLException;
     ...
     * @see TTime
     */
    public void setTime(String parameterName, TTime theTime, Calendar cal)
            throws TSQLException;
     ...
     * @see TTimestamp
     */
    public void setTimestamp(String parameterName, TTimestamp theTimestamp)
            throws TSQLException;
     ...
     * @see org.teavm.classlib.java.net.TURL
     */
    public void setURL(String parameterName, TURL theURL) throws TSQLException;
