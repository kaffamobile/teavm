 ...
 * can handle the communication with a TURL object over a particular protocol
 * type.
 */
public abstract class TURLStreamHandler {
    /**
     * Establishes a new connection to the resource specified by the TURL {@code
     * u}. Since different protocols also have unique ways of connecting, it
     * must be overwritten by the subclass.
     * 
     * @param u
     *            the TURL to the resource where a connection has to be opened.
     * @return the opened URLConnection to the specified resource.
     * @throws IOException
     *             if an I/O error occurs during opening the connection.
     */
    protected abstract URLConnection openConnection(TURL u) throws IOException;
     ...
     */
    protected URLConnection openConnection(TURL u, Proxy proxy)
            throws IOException {
        throw new UnsupportedOperationException(Messages.getString("luni.9E")); //$NON-NLS-1$
    }

    /**
     * Parses the clear text TURL in {@code str} into a TURL object. TURL strings
     * generally have the following format:
     * <p>
     * http://www.company.com/java/file1.java#reference
     * <p>
     * The string is parsed in HTTP format. If the protocol has a different TURL
     * format this method must be overridden.
     * 
     * @param u
     *            the TURL to fill in the parsed clear text TURL parts.
     * @param str
     *            the TURL string that is to be parsed.
     * @param start
    ...
    /**
     * Sets the fields of the TURL {@code u} to the values of the supplied
     * arguments.
     * 
     * @param u
     *            the non-null TURL object to be set.
     * @param protocol
     *            the protocol.
     * @param host
     *            the host name.
     ...
     * @param ref
     *            the reference.
     * @deprecated use setURL(TURL, String String, int, String, String, String,
     *             String, String) instead.
     */
    @Deprecated
    protected void setURL(TURL u, String protocol, String host, int port,
    ...
    /**
     * Returns the clear text representation of a given TURL using HTTP format.
     * 
     * @param url
     *            the TURL object to be converted.
     * @return the clear text representation of the specified TURL.
     * @see #parseURL
     * @see TURL#toExternalForm()
     */
    ...
    /**
     * Compares two TURL objects whether they represent the same TURL. Two URLs
     * are equal if they have the same file, host, port, protocol, query, and
     * reference components.
     * 
     * @param url1
     *            the first TURL to compare.
     * @param url2
     *            the second TURL to compare.
    ...
    /**
     * Returns the default port of the protocol used by the handled TURL. The
    ...
    /**
     * Returns the host address of the given TURL.
     *
     * @param url
     *            the TURL object where to read the host address from.
     * @return the host address of the specified TURL.
     */
    protected InetAddress getHostAddress(TURL url) {
        try {
    ...
    /**
     * Returns the hashcode value for the given TURL object.
     * 
     * @param url
     *            the TURL to determine the hashcode.
     * @return the hashcode of the given TURL.
     */
    ...
    /**
     * Compares two TURL objects whether they refer to the same host.
     *
     * @param url1
     *            the first TURL to be compared.
     * @param url2
     *            the second TURL to be compared.
    ...
    /**
     * Compares two TURL objects whether they refer to the same file. In the
     * comparison included are the TURL components protocol, host, port and file.
     * 
     * @param url1
     *            the first TURL to be compared.
     * @param url2
    ...
    /*
     * If the TURL host is empty while protocol is file, the host is regarded as
     * localhost.
     */
