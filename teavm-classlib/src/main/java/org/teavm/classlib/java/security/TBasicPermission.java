 ...
 */
public abstract class TBasicPermission extends TPermission implements
    TSerializable {
     ...
     */
    public TBasicPermission(String name, String action) {
        super(name);
        checkName(name);
    }
     ...
     * @see TBasicPermission#equals(Object)
     */
    @Override
    public int hashCode() {
