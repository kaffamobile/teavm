 ...
 * @see SecurityManager
 */
public final class TNetPermission extends java.security.BasicPermission {
     ...
     */
    public TNetPermission(String name) {
        super(name);
    }
     ...
     */
    public TNetPermission(String name, String actions) {
        super(name, actions);
    }
}
