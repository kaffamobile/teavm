...
public interface TBlob {
     ...
     */
    public InputStream getBinaryStream() throws TSQLException;
     ...
     *             if an error occurs accessing the {@code Blob}.
     */
    public byte[] getBytes(long pos, int length) throws TSQLException;
     ...
     *             if an error occurs accessing the {@code Blob}.
     */
    public long position(TBlob pattern, long start) throws TSQLException;
     ...
     *             if an error occurs accessing the {@code Blob}.
     */
    public long position(byte[] pattern, long start) throws TSQLException;
     ...
     *             if an error occurs accessing the {@code Blob}.
     */
    public OutputStream setBinaryStream(long pos) throws TSQLException;
     ...
     *             if an error occurs accessing the {@code Blob}.
     */
    public int setBytes(long pos, byte[] theBytes) throws TSQLException;
