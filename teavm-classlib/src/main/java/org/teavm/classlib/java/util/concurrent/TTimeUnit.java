...
/**
  ...
  * TLock.emory.mathcs.backport.Lock lock} is not available:
  *
  * <pre>  Lock lock = ...;
  ...
  * @author Doug Lea
  */
public abstract class TTimeUnit implements java.io.Serializable {

    public static final TTimeUnit NANOSECONDS = new TTimeUnit(0, "NANOSECONDS") {
        ...
        public long convert(long d, TTimeUnit u) { return u.toNanos(d); }
        int excessNanos(long d, long m) { return (int)(d - (m*C2)); }
    };
    public static final TTimeUnit MICROSECONDS = new TTimeUnit(1, "MICROSECONDS") {
        ...
        public long convert(long d, TTimeUnit u) { return u.toMicros(d); }
        int excessNanos(long d, long m) { return (int)((d*C1) - (m*C2)); }
    };
    public static final TTimeUnit MILLISECONDS = new TTimeUnit(2, "MILLISECONDS") {
        ...
        public long convert(long d, TTimeUnit u) { return u.toMillis(d); }
        int excessNanos(long d, long m) { return 0; }
    };
    public static final TTimeUnit SECONDS = new TTimeUnit(3, "SECONDS") {
        ...
        public long convert(long d, TTimeUnit u) { return u.toSeconds(d); }
        int excessNanos(long d, long m) { return 0; }
    };
    public static final TTimeUnit MINUTES = new TTimeUnit(4, "MINUTES") {
        ...
        public long convert(long d, TTimeUnit u) { return u.toMinutes(d); }
        int excessNanos(long d, long m) { return 0; }
    };
    public static final TTimeUnit HOURS = new TTimeUnit(5, "HOURS") {
        ...
        public long convert(long d, TTimeUnit u) { return u.toHours(d); }
        int excessNanos(long d, long m) { return 0; }
    };
    public static final TTimeUnit DAYS = new TTimeUnit(6, "DAYS") {
        ...
        public long convert(long d, TTimeUnit u) { return u.toDays(d); }
        int excessNanos(long d, long m) { return 0; }
    };

    private static final TTimeUnit[] values = new TTimeUnit[]
        { NANOSECONDS, MICROSECONDS, MILLISECONDS, SECONDS, MINUTES, HOURS, DAYS };

    public static TTimeUnit[] values() {
        return (TTimeUnit[])values.clone();
    }
    ...
    TTimeUnit(int index, String name) {
        this.index = index;
        this.name = name;
    }
     ...
     */
    public abstract long convert(long sourceDuration, TTimeUnit sourceUnit);
     ...
     * method (see {@link TBlockingQueue#poll BlockingQueue.poll})
     * using:
     *
