 ...
 */
public abstract class TPermission implements TGuard, Serializable {
     ...
     * otherwise.
     * <p>
     * The {@link #implies(TPermission)} method should be used for making access
     * control checks.
     *
     * @param obj
    ...
    /**
     * Invokes {@link SecurityManager#checkPermission(TPermission)} with this
     * permission as its argument. This method implements the {@link TGuard}
     * interface.
     *
     * @param obj
     *            as specified in {@link TGuard#checkGuard(Object)} but ignored
     *            in this implementation.
     * @throws SecurityException
     *             if this permission is not granted.
     * @see TGuard
     * @see SecurityManager#checkPermission(TPermission)
     */
    public void checkGuard(Object obj) throws SecurityException {
        TSecurityManager sm = TSystem.getSecurityManager();
        if (sm != null) {
    ...
    /**
     * Returns a specific {@link TPermissionCollection} container for permissions
     ...
     *
     * @return an empty {@link TPermissionCollection} or {@code null} if any
