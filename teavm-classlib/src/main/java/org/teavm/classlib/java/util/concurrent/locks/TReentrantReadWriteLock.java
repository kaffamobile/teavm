...
/**
 * An implementation of {@link TReadWriteLock} supporting similar
 * semantics to {@link TReentrantLock}.
 ...
 * write locks in the style of a {@link TReentrantLock}. Non-reentrant
 ...
 * acquisition.
 *
 * <li><b>{@link TCondition} support</b>
 * <p>The write lock provides a {@link TCondition} implementation that
 * behaves in the same way, with respect to the write lock, as the
 * {@link TCondition} implementation provided by
 * {@link TReentrantLock#newCondition} does for {@link TReentrantLock}.
 * This {@link TCondition} can, of course, only be used with the write lock.
 *
 * <p>The read lock does not support a {@link TCondition} and
 ...
 *
 */
public class TReentrantReadWriteLock implements TReadWriteLock, java.io.Serializable  {
    ...
    public TLock writeLock() { return writerLock_; }
    public TLock readLock()  { return readerLock_; }
    ...
    /**
     * The lock returned by method {@link TReentrantReadWriteLock#readLock}.
     */
    public static class ReadLock implements TLock, java.io.Serializable {

        private static final long serialVersionUID = -5992448646407690164L;

        final TReentrantReadWriteLock lock;
         ...
         * for this lock, then use {@link #tryLock(long, TTimeUnit)
         ...
         *
         */
        public boolean tryLock(long timeout, TTimeUnit unit) throws InterruptedException {
            if (Thread.interrupted()) throw new InterruptedException();
            InterruptedException ie = null;
            ...
            synchronized (this) {
                if (nanos <= 0)
                    ...
                    for (; ; ) {
                        try {
                            TTimeUnit.NANOSECONDS.timedWait(ReadLock.this, nanos);
                        }
                        catch (InterruptedException ex) {
                            lock.sync.cancelledWaitingReader();
                            ie = ex;
    ...
    /**
     * The lock returned by method {@link TReentrantReadWriteLock#writeLock}.
     */
    public static class WriteLock implements TLock, TCondVar.ExclusiveLock,
         ...
         * #tryLock(long, TTimeUnit) tryLock(0, TimeUnit.SECONDS) }
        ...
        public boolean tryLock(long timeout, TTimeUnit unit) throws InterruptedException {
            ...
            synchronized (this) {
                if (nanos <= 0)
                    ...
                    for (; ; ) {
                        try {
                            TTimeUnit.NANOSECONDS.timedWait(WriteLock.this, nanos);
                        }
                        catch (InterruptedException ex) {
                            lock.sync.cancelledWaitingWriter();
                            WriteLock.this.notify();
        ...
        /**
         * Returns a {@link TCondition} instance for use with this
         * {@link TLock} instance.
         * <p>The returned {@link TCondition} instance supports the same
         ...
         * TCondition} method is called then an {@link
         ...
         * lock.)
         *
         * <li>When the condition {@linkplain TCondition#await() waiting}
         ...
         * TReentrantReadWriteLock#isWriteLockedByCurrentThread}.
         *
         ...
         * to {@link TReentrantReadWriteLock#getWriteHoldCount}.
         *
