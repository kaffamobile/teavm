...
public class TCopyOnWriteArrayList implements List, RandomAccess, Cloneable, Serializable {
    ...
    public TCopyOnWriteArrayList(Object[] array) {
    ...
    class COWSubList implements Serializable, List {
        ...
        public boolean remove(Object o) {
            synchronized (TCopyOnWriteArrayList.this) {
                Object[] array = getArray();
