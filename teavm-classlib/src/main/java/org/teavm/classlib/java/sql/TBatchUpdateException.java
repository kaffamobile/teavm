 ...
 */
public class TBatchUpdateException extends TSQLException implements Serializable {
     ...
     */
    public TBatchUpdateException(int[] updateCounts) {
        super();
     ...
     *            in the batch that was attempted.
     */
    public TBatchUpdateException(String reason, int[] updateCounts) {
        super(reason);
        this.updateCounts = updateCounts;
    }
     ...
     *            in the batch that was attempted.
     */
    public TBatchUpdateException(String reason, String SQLState,
            int[] updateCounts) {
     ...
     *            in the batch that was attempted.
     */
    public TBatchUpdateException(String reason, String SQLState, int vendorCode,
            int[] updateCounts) {
