 ...
 * </ul>
 * 
 * @see TDatabaseMetaData
 */
public class TSQLException extends Exception implements Serializable {
    ...
    private TSQLException next = null;
     ...
     */
    public TSQLException(String theReason) {
     ...
     */
    public TSQLException(String theReason, String theSQLState) {
     ...
     */
    public TSQLException(String theReason, String theSQLState, int theErrorCode) {
        super(theReason);
