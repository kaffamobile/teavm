 ...
 * atomically.  See the {@link org.teavm.classlib.java.util.concurrent.atomic} package
 * specification for description of the properties of atomic
 * variables.
 * @since 1.5
 * @author Doug Lea
 */
public class TAtomicReferenceArray implements java.io.Serializable {
     ...
     */
    public TAtomicReferenceArray(Object[] array) {
        if (array == null)
