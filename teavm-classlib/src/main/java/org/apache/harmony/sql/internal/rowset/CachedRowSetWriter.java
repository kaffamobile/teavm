...
public class CachedRowSetWriter implements RowSetWriter {
    ...
    private TConnection originalConnection;
    ...
    public void setConnection(TConnection conn) {
    ...
    public boolean writeData(RowSetInternal theRowSet) throws TSQLException {
        init(theRowSet);
    ...
    private void addConflict(int status) throws TSQLException {
        if (resolver == null) {
     ...
     */
    private void insertCurrentRow() throws TSQLException {
        /*
         ...
         */
        TPreparedStatement preSt = getConnection().prepareStatement(
                insertSQL.toString());
        try {
     ...
     * @throws TSQLException
     */
    private void deleteCurrentRow() throws TSQLException {
        /*
     ...
     * @throws TSQLException
     */
    private void updateCurrentRow() throws TSQLException {
        /*
         * the first step: generate the delete SQL
         */
    ...
    private void init(RowSetInternal theRowSet) throws TSQLException {
     ...
     * @throws TSQLException
     */
    private boolean isConflictExistForCurrentRow() throws TSQLException {
     ...
     */
    private String generateQueryCondition() throws TSQLException {
     ...
     * @throws TSQLException
     */
    private void fillParamInPreStatement(TPreparedStatement preSt, int fromIndex)
            throws TSQLException {
