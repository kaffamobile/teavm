...
public class CachedRow implements Cloneable, Serializable {
    ...
    private TSQLWarning sqlWarning = null;

    public TSQLWarning getSqlWarning() {
        return sqlWarning;
    }

    public void setSqlWarning(TSQLWarning sqlWarning) {
    ...
    public void updateObject(int columnIndex, Object x) throws TSQLException {
        if (nonUpdateable) {
            ...
            throw new TSQLException(Messages.getString("rowset.21")); //$NON-NLS-1$
        }
