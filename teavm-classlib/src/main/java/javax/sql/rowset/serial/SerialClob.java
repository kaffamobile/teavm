...
public class SerialClob implements TClob, Serializable, Cloneable {
    ...
    public SerialClob(char[] ch) throws SerialException, TSQLException {
    ...
    public SerialClob(TClob clob) throws SerialException, TSQLException {
        Reader characterStream;
        InputStream asciiStream;

        if (clob == null) {
            throw new TSQLException(Messages.getString("sql.19"));//$NON-NLS-1$
        }
        if ((characterStream = clob.getCharacterStream()) == null
                && (asciiStream = clob.getAsciiStream()) == null) {
            throw new TSQLException(Messages.getString("sql.20"));//$NON-NLS-1$
        }
    ...
    public InputStream getAsciiStream() throws SerialException, TSQLException {
        checkValidation();
        if (clob == null) {
    ...
    public long position(TClob searchClob, long start) throws SerialException,
            TSQLException {
        checkValidation();
