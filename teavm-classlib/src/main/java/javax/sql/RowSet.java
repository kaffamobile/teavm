 ...
 * {@link org.teavm.classlib.java.sql.TResultSet ResultSet} into a form that it can be used as a
 ...
 * @see RowSetWriter
 */
public interface RowSet extends TResultSet {
     ...
     *         </ul>
     * @see org.teavm.classlib.java.sql.TConnection
     */
     ...
     * @throws TSQLException
     *             if an error occurs accessing the database.
     * @see org.teavm.classlib.java.sql.TResultSet
     */
     ...
     *             if an error occurs accessing the database.
     */
    public void setDate(int parameterIndex, TDate theDate, Calendar theCalendar)
            throws TSQLException;
     ...
     *             if an error occurs accessing the database.
     */
    public void setInt(int parameterIndex, int theInteger) throws TSQLException;
     ...
     *             if an error occurs accessing the database.
     */
    public void setPassword(String password) throws TSQLException;
     ...
     * @throws TSQLException
     *             if an error occurs accessing the database.
     * @see org.teavm.classlib.java.sql.TRef
     */
     ...
     * @see org.teavm.classlib.java.sql.TTime
     */
     ...
     * @see org.teavm.classlib.java.sql.TTime
     */
    public void setTime(int parameterIndex, TTime theTime, Calendar theCalendar)
            throws TSQLException;
     ...
     *             if an error occurs accessing the database.
     * @see java.util.Calendar
     * @see org.teavm.classlib.java.sql.TTimestamp
     */
     ...
     */
    public void setTimestamp(int parameterIndex, TTimestamp theTimestamp,
            Calendar theCalendar) throws TSQLException;
     ...
     * Java classes must all implement the {@link org.teavm.classlib.java.sql.TSQLData SQLData}
     * interface.
     * 
     * @param theTypeMap
     ...
     *             if an error occurs accessing the database.
     */
    public void setUrl(String theURL) throws TSQLException;
     ...
     *             if an error occurs accessing the database.
     */
    public void setUsername(String theUsername) throws TSQLException;
}
